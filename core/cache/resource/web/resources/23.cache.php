<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1554297170,
    'editedby' => 5,
    'editedon' => 1618413742,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1554297120,
    'publishedby' => 1,
    'menutitle' => 'новини',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    'show_in_tree' => 1,
    'properties' => '{"autoredirector":{"old_uri":"novyny\\/"}}',
    'seo_descr' => 
    array (
      0 => 'seo_descr',
      1 => '',
...
<head>
	...
	<title>[[!If? &subject=`23` &operator=`!=` &operand=`1` &then=`Новини | `]][[!If?
                &subject=`[[!getContext? id=`23`]]`
                &operator=`==`
                &operand=`web`
	...
	<meta property="og:title" content="[[!If? &subject=`23` &operator=`!=` &operand=`1` &then=`Новини | `]]Центр хірургії ока проф. Загурського">
...
<body>
    ...
    <a href="https://zagorski.com.ua/novyny/" class="active">ua</a>
</div>
				</div>
	    ...
	    <section id="articles-list">
			<div class="container">
				<div class="list three-col">
					<div class="article">
	<div class="photo" style="background-image: url(/assets/components/phpthumbof/cache/%20%D0%9F%D1%80%D0%BE%D1%81%D1%82%D0%BE%D0%B9%20UI%20%D0%A0%D0%B0%D1%81%D0%BF%D1%80%D0%BE%D0%B4%D0%B0%D0%B6%D0%B0%20%D0%97%D0%B0%D0%BF%D0%B8%D1%81%D1%8C%20%D0%B2%20Instagram.da01ea4a46db4ba240f3b31cbc5f2049.png)">
	    [[!If?
            &subject=`[[!getContext? id=`23`]]`
            &operator=`==`
            &operand=`web`
            &then=`
                <a href="/novyny/zminy-u-hrafiku-roboty"></a>
            `
            &else=`
                <a href="/en/novyny/zminy-u-hrafiku-roboty"></a>
            `
        ]]
	</div>
	<div class="content">
		<h2>З Днем прапора та 30 річницею Незалежності України!</h2>
		<p>23 та 24 серпня Центр хірургії ока професора Загурського вихідний. Чекаємо Вас з 25 серпня.  Будні з 9.00 до 19.00 Субота з 9.00 - 18.00...</p>
		<div class="btn">
		    [[!If?
                &subject=`[[!getContext? id=`23`]]`
                &operator=`==`
                &operand=`web`
                &then=`
                    <a href="/novyny/zminy-u-hrafiku-roboty">читати далі</a>
                `
                &else=`
                    <a href="/en/novyny/zminy-u-hrafiku-roboty">read more</a>
                `
            ]]
		</div>
	</div>
...
<div class="article">
	<div class="photo" style="background-image: url(/assets/components/phpthumbof/cache/%20%D1%81%D1%82%D0%B0%D0%B6%D1%83%D0%B2%D0%B0%D0%BD%D0%BD%D1%8F.956d76f9085800f14caa25349216e989.jpg)">
	    [[!If?
            &subject=`[[!getContext? id=`23`]]`
            &operator=`==`
            &operand=`web`
            &then=`
                <a href="/novyny/mizhnarodne-stazhuvannia"></a>
            `
            &else=`
                <a href="/en/novyny/mizhnarodne-stazhuvannia"></a>
            `
        ]]
	</div>
	<div class="content">
		<h2>Міжнародне стажування</h2>
		<p>Найбільша світова мережа офтальмологічних центрів - “Dünyagöz” приймає лікарів-офтальмологів Центру хірургії ока професора Загурського із Луцька.</p>
		<div class="btn">
		    [[!If?
                &subject=`[[!getContext? id=`23`]]`
                &operator=`==`
                &operand=`web`
                &then=`
                    <a href="/novyny/mizhnarodne-stazhuvannia">читати далі</a>
                `
                &else=`
                    <a href="/en/novyny/mizhnarodne-stazhuvannia">read more</a>
                `
            ]]
		</div>
	</div>
...
<div class="article">
	<div class="photo" style="background-image: url(/assets/components/phpthumbof/cache/.504915f5085de51adbf6da75d851397f.jpg)">
	    [[!If?
            &subject=`[[!getContext? id=`23`]]`
            &operator=`==`
            &operand=`web`
            &then=`
                <a href="/novyny/uvaha-remont"></a>
            `
            &else=`
                <a href="/en/novyny/uvaha-remont"></a>
            `
        ]]
	</div>
	<div class="content">
		<h2>Увага! Ремонт</h2>
		<p>До уваги відвідувачів Центру хірургії ока професора Загурського! У період з 28 червня по 3 липня 2021р. у медичному Центрі буде тривати ремонт....</p>
		<div class="btn">
		    [[!If?
                &subject=`[[!getContext? id=`23`]]`
                &operator=`==`
                &operand=`web`
                &then=`
                    <a href="/novyny/uvaha-remont">читати далі</a>
                `
                &else=`
                    <a href="/en/novyny/uvaha-remont">read more</a>
                `
            ]]
		</div>
	</div>
...
<div class="article">
	<div class="photo" style="background-image: url(/assets/components/phpthumbof/cache/IMG_9833.beb54bdd90572671ab33ef06bb19fee3.jpg)">
	    [[!If?
            &subject=`[[!getContext? id=`23`]]`
            &operator=`==`
            &operand=`web`
            &then=`
                <a href="/novyny/novitnia-tekhnolohiia-vymiriuvannia-vnutrishnoochnoho-tysku-tonometr-i"></a>
            `
            &else=`
                <a href="/en/novyny/novitnia-tekhnolohiia-vymiriuvannia-vnutrishnoochnoho-tysku-tonometr-i"></a>
            `
        ]]
	</div>
	<div class="content">
		<h2>Новітня технологія. Тонометр iCare ic200</h2>
		<p>Іcare CLINIC – це революція у лікуванні глаукоми та новий рівень аналізу внутрішньоочного тиску у клінічній практиці лікаря....</p>
		<div class="btn">
		    [[!If?
                &subject=`[[!getContext? id=`23`]]`
                &operator=`==`
                &operand=`web`
                &then=`
                    <a href="/novyny/novitnia-tekhnolohiia-vymiriuvannia-vnutrishnoochnoho-tysku-tonometr-i">читати далі</a>
                `
                &else=`
                    <a href="/en/novyny/novitnia-tekhnolohiia-vymiriuvannia-vnutrishnoochnoho-tysku-tonometr-i">read more</a>
                `
            ]]
		</div>
	</div>
...
<div class="article">
	<div class="photo" style="background-image: url(/assets/components/phpthumbof/cache/IMG_2524.beb54bdd90572671ab33ef06bb19fee3.jpg)">
	    [[!If?
            &subject=`[[!getContext? id=`23`]]`
            &operator=`==`
            &operand=`web`
            &then=`
                <a href="/novyny/novynky-obladnannia-nalobnyi-oftalmoskop"></a>
            `
            &else=`
                <a href="/en/novyny/novynky-obladnannia-nalobnyi-oftalmoskop"></a>
            `
        ]]
	</div>
	<div class="content">
		<h2>Новинки обладнання. Налобний офтальмоскоп.</h2>
		<p>Прагнемо аби діагностика зору була точною, швидкою, комфортною, досконалою та відповідала сучасним запитам пацієнтів.</p>
		<div class="btn">
		    [[!If?
                &subject=`[[!getContext? id=`23`]]`
                &operator=`==`
                &operand=`web`
                &then=`
                    <a href="/novyny/novynky-obladnannia-nalobnyi-oftalmoskop">читати далі</a>
                `
                &else=`
                    <a href="/en/novyny/novynky-obladnannia-nalobnyi-oftalmoskop">read more</a>
                `
            ]]
		</div>
	</div>
...
<div class="article">
	<div class="photo" style="background-image: url(/assets/components/phpthumbof/cache/IMG_5982.beb54bdd90572671ab33ef06bb19fee3.jpg)">
	    [[!If?
            &subject=`[[!getContext? id=`23`]]`
            &operator=`==`
            &operand=`web`
            &then=`
                <a href="/novyny/bezpeka-v-operatsiinii-tse-vazhlyvo"></a>
            `
            &else=`
                <a href="/en/novyny/bezpeka-v-operatsiinii-tse-vazhlyvo"></a>
            `
        ]]
	</div>
	<div class="content">
		<h2>Безпека в операційній - це важливо!</h2>
		<p>Ми стерилізуємо інструменти перед кожною операцією. У нас Ви будете впевнені у власній безпеці.</p>
		<div class="btn">
		    [[!If?
                &subject=`[[!getContext? id=`23`]]`
                &operator=`==`
                &operand=`web`
                &then=`
                    <a href="/novyny/bezpeka-v-operatsiinii-tse-vazhlyvo">читати далі</a>
                `
                &else=`
                    <a href="/en/novyny/bezpeka-v-operatsiinii-tse-vazhlyvo">read more</a>
                `
            ]]
		</div>
	</div>
				...
				<button class="more more-articles" data-action="getResources" data-parent="23" data-offset="6">завантажити ще</button>
    ...
    <div id="to-top"></div>
<footer>
	<nav class="menu [[!If? &subject=`[[!getContext? id=`23`]]` &operator=`==` &operand=`en` &then=`engm`]]">
	    [[!If?
            &subject=`[[!getContext? id=`23`]]`
            &operator=`==`
            &operand=`web`
...
<!-- End Google Tag Manager (noscript) -->
  ...
  array (
    ...
    '[[getResourceField? &id=`23` &field=`alias`]]' => 'novyny',
    '[[pdoResources?
                        &parents=`23`
                        &depth=`1`
                        &limit=`6`
